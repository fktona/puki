...
export default function Social() {
  return (
    ...
    <div className='bg-white/5 lg:w-[100px] w-[80px] flex items-center aspect-square justify-center hover:scale-110 transition-all duration-300 lg:rounded-[22px] rounded-md'><Image src='/sc.png' width={50} height={50} alt='sc' /></div>
