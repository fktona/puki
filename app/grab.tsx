    ...
    <section ref={dexRef}
     className='grab max-w-[1440px] mx-auto w-full
      ...
      lg:space-y-[150px] lg:py-[68px] py-[50px] space-y-[100px]'>
        ...
        <a href="https://dexscreener.com/solana/GwjR1knoW4KMcBGPKrURwvntqUyRenoaF4YyzwR8VYoy"><button className='herobtn lg:px-[50px] px-[24px] mt-[45px] text-[35px] lg:text-[64px] lg:py-[6.7px]'>
        Grab  $PUKI
        </button></a>
