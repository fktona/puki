...
export default function About() {
  ...
  return (
    <main ref={aboutRef} 
    className=' relative  flex justify-between flex-col md:flex-row items-center px-[25px] py-[50px]  gap-10  lg:px-[107px]
     lg:py-[91px] md:py-[65px] md:px-[35px]  bg-[#341A1D]/80'>
